...
A total of 1 test files matched the specified pattern.
  ! ParseData_WithMixedData_ReturnsGoodRecords [18ms]
  ! ParseData_WithGoodRecord_ReturnsOneRecord [< 1ms]
  ! ParseData_WithBadRecord_ReturnsZeroRecords [< 1ms]
  ! ParseData_WithBadStartDate_ReturnsZeroRecords [< 1ms]
  ! ParseData_WithBadRating_ReturnsZeroRecords [< 1ms]

Test Run Successful.
Total tests: 9
     Passed: 4
    Skipped: 5
 Total time: 0.8203 Seconds
 ```
